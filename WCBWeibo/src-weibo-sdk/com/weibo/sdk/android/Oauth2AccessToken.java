...
public class Oauth2AccessToken {
	...
	private static final String KEY_USER_NAME = "weibo_user_name";
	private static final String KEY_USER_ID = "weibo_user_id";
	private static final String KEY_EXPIRES_TIME = "weibbo_expires_time";
	...
	// 设置userName
	public void setUserName(String muUser) {
		this.mUserName = muUser;
	}

	// 设置userName
	public void setUserId(String muUserId) {
		this.mUserId = muUserId;
	}
	// /**
	// * 设置检验者
	// * @param verifier
